...
test:
	nosetests src/tests --with-coverage --cover-package=app,contentful_adapter,mail_integration

pt:
	nosetests src/tests --with-coverage --cover-package=app,contentful_adapter,mail_integration --nocapture
